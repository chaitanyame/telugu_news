...
class TestProcessTimeSlot:
    ...
    def test_successful_processing(
        ...
        mock_load, mock_gemini, mock_search, mock_yt_client,
        mock_is_processed, mock_gemini_key, mock_yt_key
    ):
        """Test successful end-to-end processing"""
        # Mock API keys
        mock_yt_key.return_value = "test_yt_key"
        ...
        # Mock YouTube client
        mock_yt_client.return_value = Mock()
        
        # Mock video search result
        mock_search.return_value = {
            "video_id": "abc12345678",
            "title": "9 PM | ETV Telugu News | 09th Dec 2025",
    ...
    def test_video_already_processed(
        self, mock_is_processed, mock_search, mock_yt_client,
        mock_gemini_key, mock_yt_key
    ):
        """Test skipping already processed video"""
        mock_yt_key.return_value = "test_key"
    ...
    def test_video_not_found(
        self, mock_search, mock_yt_client, mock_is_processed,
        mock_gemini_key, mock_yt_key
    ):
    ...
    @patch('scripts.process_daily_news.get_youtube_api_key')
    def test_missing_api_key(self, mock_yt_key):
        """Test error handling for missing API key"""
        mock_yt_key.side_effect = ValueError("Missing API key")
